    ...
    <body>
        <section class="contenedor">
            ...
            <section class="contenido" id="contenidoGeneral2">
                <h1>Existencias de Esmerilada</h1>
                
                <?php
                if($_POST)
                {?>
                    <form id="formReporteEsmerilada" method="post">
                        <?php 
                        ...
                        ?>                        
                        <input id="btnConsultarEsmerilada" type="submit" value="Consultar">
                        <input id="btnGenerarEsmerilada" type="submit" value="Generar PDF">
                    </form>    
                <?php
                }
                else
                ...
                <div class="listado">                                      
                    ...
                    if($_POST)
                    {
                        ...
                        if($dateFin>=$dateInicio){
                            ...
                            if ($objStockImpl->getCountEsmeriladaBetweenDate($_POST['txbFechaInicio'], $_POST['txbFechaFin'], $_POST['txbReferencia']) > 0)
                            {
                            ?>
                                <form method="post">
                                <table>
								...
								foreach ($objStockImpl->getByEsmeriladaBetweenDate($_POST['txbFechaInicio'], $_POST['txbFechaFin'], $_POST['txbReferencia'], $_POST['selectColor']) as $valorStock) {
                                    $quantityAvailable = $objStockImpl->getQuantityAvailableEsmerilada($valorStock->getCode(), $valorStock->getColor(), $_POST['txbFechaInicio'], $_POST['txbFechaFin']);
                                    $quantitySale = $objStockImpl->getQuantityEsmerilada($valorStock->getCode(), $valorStock->getColor(), $_POST['txbFechaInicio'], $_POST['txbFechaFin']);
                                ...
                                foreach ($arrTemp as $valorStock) {
                                    ...
                                    echo '<tr>
                                        ...
                                        echo '<td class="tdDerecha">'.$totalCantidad.'</td> 
                                    </tr>';
