    ...
    <body>
        <section class="contenedor">
            ...
            <section class="contenido" id="contenidoGeneral2">
                ...
                <form id="formReportCodebar" method="post">                        
                    <input id="txbReferencia" name="txbReferencia" type="text" placeholder="REFERENCIA" maxlength="60" required>
                    <?php
                        ...
                        echo '</select>'; 
                    ?>
                    <input id="btnGenerarCodebars" type="submit" value="Generar PDF">
                </form>
            </section>
