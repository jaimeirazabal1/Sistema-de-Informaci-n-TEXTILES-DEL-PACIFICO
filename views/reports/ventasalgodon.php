    ...
    <body>
        <section class="contenedor">
            ...
            <section class="contenido" id="contenidoGeneral2">
                <h1>Ventas Algodon X Color</h1>
                
                <?php
                if($_POST)
                {?>
                    <form id="formVentasAlgodon" method="post">
                        <?php 
                        ...
                        ?>                        
                        <input id="btnVentasAlgodon" type="submit" value="Consultar">
                        <input id="btnGenerarVentasAlgodon" type="submit" value="Generar PDF">
                    </form>    
                <?php
                }
                else
                {?>
                    <form id="formVentasAlgodonformVentasAlgodon" method="post">
                        <?php 
                        $dateNow = date("Y-m-d");
                ...
                <div class="listado">                                      
                    ...
                    if($_POST)
                    {
                        ...
                        if($dateFin>=$dateInicio){
                            ...
                            if ($objStockImpl->getCountAlgodonBetweenDate($_POST['txbFechaInicio'], $_POST['txbFechaFin'], $_POST['txbReferencia']) > 0)
                            {
                            ?>
                                <form method="post">
                                <table>
                                ...
                                foreach ($objStockImpl->getByVentasAlgodonBetweenDate($_POST['txbFechaInicio'], $_POST['txbFechaFin'], $_POST['txbReferencia'], $_POST['selectColor']) as $valorStock) {
