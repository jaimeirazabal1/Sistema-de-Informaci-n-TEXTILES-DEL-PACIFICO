    ...
    <body>
        <section class="contenedor">
            ...
            <section class="contenido" id="contenidoGeneral2">
                <h1>Existencias de Viscosa</h1>
                
                <?php
                if($_POST)
                {?>
                    <form id="formReporteViscosa" method="post">
                        <?php 
                        ...
                        ?>                        
                        <input id="btnConsultarViscosa" type="submit" value="Consultar">
                        <input id="btnGenerarViscosa" type="submit" value="Generar PDF">
                    </form>    
                <?php
                }
                else
