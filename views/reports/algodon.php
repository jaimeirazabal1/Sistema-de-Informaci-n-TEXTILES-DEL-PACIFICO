            ...
            <section class="contenido" id="contenidoGeneral2">
                ...
                {?>
                    <form id="formReporteAlgodon" method="post">
                        ...
                        ?>                        
                        <input id="btnConsultarAlgodon" type="submit" value="Consultar">
                        <input id="btnGenerarAlgodon" type="submit" value="Generar PDF">
                    </form>    
                <?php
                }
                else
                    ...
                    if($_POST)
                    {
                        ...
                        if($dateFin>=$dateInicio){
                            ...
                            ?>
								...
								foreach ($objStockImpl->getByAlgodonBetweenDate($_POST['txbFechaInicio'], $_POST['txbFechaFin'], $_POST['txbReferencia'], $_POST['selectColor']) as $valorStock) {
