    ...
    <body>
        <section class="contenedor">
            ...
            <section class="contenido" id="contenidoGeneral2">
                <h1>Existencias Rayas</h1>
                
                <?php
                if($_POST)
                {?>
                    <form id="formReporteRayas" method="post">
                        <?php 
                        ...
                        ?>                        
                        <input id="btnConsultarRayas" type="submit" value="Consultar">
                        <input id="btnGenerarRayas" type="submit" value="Generar PDF">
                    </form>    
                <?php
                }
                else
