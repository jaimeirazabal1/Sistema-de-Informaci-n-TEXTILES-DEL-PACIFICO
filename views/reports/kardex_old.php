                            ...
                            ?>
                                ...
                                <table>                                
                                    <tr>
                                        ...
                                        <th class="tdColor color-black">FECHA</th>
...
//                              echo  '<script>console.log("ahi va")</script>';
                                ...
                                foreach ($objStockImpl->getWithoutDocument($_POST['txbReferencia']) as $valorSD) {
                                    ...
                                    echo '<tr>
                                        ...
                                        <td></td>
                                        <td class="tdDerecha">'.$totalSaldo.'</td>
                                        ...
                                        <td></td>
                                        <td class="tdDerecha">'.number_format($totalSaldoPesos).'</td>
                                        </tr>';
                                ...
                                echo '<tr>
                                        <td class="tdColor color-black"></td>
                                        <td class="tdColor color-black"></td>
                                        <td class="tdColor color-black"></td>
                                        <td class="tdColor color-black"></td>
                                        <td class="tdColor color-black"></td>
                                ...
                                echo '<tr>
                                        <td></td>
                                        <td></td>
                                        <td class="tdDerecha">'.$totalEntradas.'</td>
                                        <td class="tdDerecha">'.$totalSalidas.'</td>
                                        <td class="tdDerecha">'.($totalEntradas-$totalSalidas).'</td>
                                        <td></td>
                                        <td class="tdDerecha">'.number_format($totalCostoEntradas).'</td>
                                        <td class="tdDerecha">'.number_format($totalCostoSalidas).'</td>
                                        <td class="tdDerecha">'.number_format($totalCostoEntradas-$totalCostoSalidas).'</td>
                                        </tr>';                                
