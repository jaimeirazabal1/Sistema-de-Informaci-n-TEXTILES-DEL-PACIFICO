    ...
    <body>
        <section class="contenedor">
            ...
            <section class="contenido" id="contenidoGeneral2">
                ...
                if($_POST)
                {?>
                    <form id="formReporteAlgodon" method="post">
                        <?php 
                        ...
                        echo '<input id="txbReferencia" name="txbReferencia" type="text" placeholder="CLIENTE" value="'.$_POST['txbReferencia'].'">';
                        
                        ?>                        
                        <input id="btnConsultarRecaudos" type="submit" value="Consultar">
                        <input id="btnGenerarRecaudos" type="submit" value="Generar PDF">
                    </form>    
                <?php
                }
                else
                {?>
                    <form id="formReporteRecaudos" method="post">
                        <?php 
                        $dateNow = date("Y-m-d");
                        ...
                        ?>
                        <input id="txbReferencia" name="txbReferencia" type="text" placeholder="CLIENTE">
                ...
                <div class="listado">                                      
                    ...
                    if($_POST)
                    {
                        ...
                        if($dateFin>=$dateInicio){
                            ...
                            if ($objCollectImpl->getPagosBetweenDate($_POST['txbFechaInicio'], $_POST['txbFechaFin'], $_POST['txbReferencia']) > 0)
                            {
                            ?>
                                <form method="post">
                                <table>
								...
								foreach ($objCollectImpl->getPagosBetweenDate($_POST['txbFechaInicio'], $_POST['txbFechaFin'], $_POST['txbReferencia'], $_POST['selectColor']) as $valorStock) {
