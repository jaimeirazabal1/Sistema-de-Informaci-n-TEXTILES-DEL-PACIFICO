...
<html>
    <head>
        ...
        <title>Reporte Remisiones</title>
    </head>
    <body>
        <section class="contenedor">
            ...
            <section class="contenido" id="contenidoGeneral2">
                <h1>Remisiones x Rango de Fechas</h1>
            ...
            <section class="contenido" id="contenidoGeneral2">                
                <div class="listado">                                        
                            ...
                            if($_POST)
                            {
                                ...
                                if ($objRemisionImpl->getCountByReport($_POST['txbFechaInicio'], $_POST['txbFechaFin'], $_POST['txbReferencia'], $_POST['txbArticulo'], $_POST['txbCliente']) > 0)
                                {
                                ?>
                                ...
                                foreach ($objRemisionImpl->getByReport($_POST['txbFechaInicio'], $_POST['txbFechaFin'], $_POST['txbReferencia'], $_POST['txbArticulo'], $_POST['txbCliente']) as $valorStock) {
                                    echo '<tr>
                            ...
                            <?php
                                if(strcmp($_POST['txbCliente'], "") != 0)
                                    echo '<p>Total facturas cliente: $ '.number_format ($objRemisionImpl->getSumByClient($_POST['txbCliente'], $_POST['txbFechaInicio'], $_POST['txbFechaFin'], strtoupper($_POST['txbReferencia'])));                              
                                }
                                else
                                {
