        ...
        <section class="contenedor">
            ...
            <nav id="menu">
                <ul>
                    ...
                    <li><a href="../bill"><img src="../../res/document-16.png">Facturación</a></li>
            ...
            <section class="contenido" id="contenidoGeneral">
                <div class="encabezadoContenido">
                    <div class="tituloContenido"><h1>Gestión Facturación</h1></div><div class="agregarDato">
                        <a href="add_bill.php"><input type="button" value="Crear Factura"></a></div><div class="buscar">
