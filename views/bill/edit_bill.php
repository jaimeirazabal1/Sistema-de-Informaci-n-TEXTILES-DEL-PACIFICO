        ...
        <section class="contenedor">
            ...
            <section class="contenido" id="contenidoGeneral">
                ...
                <?php   
                    ...
                    echo '<input type="hidden" id="typeHidden" value="FA">';
...
<!--                                <th>MOVIMIENTO</th>-->
                        ...
                        <table>
                            ...
                            foreach ($objDetailImpl->getByCode($billNumber) as $valor) {
                                ...
                                <?php }
                                        ...
                                        echo '<td class="tdDerecha" id="tdd2'.$contDetail.'">'.$valor->getQuantity().'</td>';
                                    ...
                                    ?>
                                      ...
                                      <td id="tdAcciones">
                                            ...
                                            echo '<a href="../../controllers/ctrlDeleteDetail.php?idf='.$billNumber.'&ida='.$valor->getCodeArticle().'&q='.$valor->getQuantity().'&cl='.$valor->getColor().'&cj='.$_GET['cj'].'"><img src="../../res/x-mark-16.png"></a>';                                                                                    
                                            ?>                                        
                                        </td>
                                </tr>                                                     
                            <?php
                ...
                <div class="encabezadoContenido">
                    <div class="tituloContenido" id="pago"></div><div class="agregarDato"></div><div class="buscar">
                        ...
                        {
                            echo '<select name = "selectPayment" id="selectPaymentBill" class="fa">';     
                        ...
                        {
                            echo '<select name = "selectPayment" id="selectPaymentBill"  class="fa" disabled>';     
                        ...
                        echo '<a target="_blank" href="../../controllers/ctrlPrintBill.php?id='.$billNumber.'&cj='.$_GET['cj'].'"><input type="button" value="Imprimir"></a>'; 
                        ?>
                        <br>
                        <br>
            ...
            if(isset($_GET)){
                ...
                if ($num_rows_credit > 0) {
                    ...
                    $idCredit = $objCreditImpl->getId($_GET['id'], 'FA');                    
