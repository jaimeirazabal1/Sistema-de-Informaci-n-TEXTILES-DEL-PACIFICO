        ...
        <section class="contenedor">
            ...
            <section class="contenido" id="contenidoGeneral">
                        ...
                        <table>
                            ...
                            foreach ($objDetailImpl->getByCode($billNumber) as $valor) {
                                ...
                                ?>
                                        ...
                                        echo '<td id="td3'.$cont.'" class="tdDerecha">'.number_format($valor->getQuantity(),0).'</td>';
                ...
                <div class="encabezadoContenido">
                    <div class="tituloContenido"><h1 id="h1Total">Total canjeable sin IVA: $ 0</h1></div><div class="agregarDato"></div><div class="buscar">
                        <?php echo '<input type="button" id="btnChangeFin" value="Cambiar">'; ?>                        
                    </div>                    
                </div> 
            ...
            <div class="detallesDevueltas">
                <form>                        
                    ...
                    <input id="txbCantidadCambiar" min="1" type="number">
                    <input id="btnAddChange" type="button" value="Agregar">
