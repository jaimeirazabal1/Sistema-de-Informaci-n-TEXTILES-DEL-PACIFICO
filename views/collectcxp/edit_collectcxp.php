        ...
        <section class="contenedor">
            ...
            {?>
                <section class="contenido" id="contenidoGeneral">
                    ...
                    <form method="post" action="../../controllers/ctrlEditCollectCxp.php">
                        <?php
                        include_once '../../models/CollectCxp.php';
                        include_once '../../models/CollectCxpImpl.php';
                        $objCollectCxpImpl = new CollectCxpImpl();
                        

                        foreach ($objCollectCxpImpl->getByCode($_GET['idr']) as $valor) {   
                            echo '<input type="hidden" value="'.$valor->getCode().'" name="txbCodeHidden">';
                            echo '<input type="hidden" value="'.$valor->getCodeCxp().'" name="txbCodeCreditHidden">';
