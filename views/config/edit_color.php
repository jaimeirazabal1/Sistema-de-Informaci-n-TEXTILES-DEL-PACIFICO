        ...
        <section class="contenedor">
            ...
            {?>
                <section class="contenido" id="contenidoGeneral">
                    <h1>Editar Color</h1>
                    <form method="post" action="../../controllers/ctrlEditColor.php">
                        <?php
                        ...
                        if($objStockImpl->getCountColorFromStock($objStock) > 0)
                        {
                            foreach ($objColorImpl->getByCode($_GET[id]) as $valor) {   
                                ...
                                echo '<input type="text" value="'.$valor->getName().'" name="txbName" placeholder="Nombre" maxlength="60" required>';                            
                            }
