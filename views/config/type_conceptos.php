            ...
            <section class="contenido" id="contenidoGeneral">
                <div class="encabezadoContenido">
                    <div class="tituloContenido"><h1>Gestión Conceptos</h1></div><div class="agregarDato">
                        <a href="add_type_conceptos.php"><input type="button" value="Agregar"></a></div><div class="buscar">
                            <input type="text" id="txbSearchConceptos" placeholder="Buscar...">
                        </div>                    
                </div>
                <div class="listado">
                    ...
                    <form method="post" action="">
                        <table>
                            ...
                            <?php
                            require '../../models/TypeConceptosImpl.php';
                            $objTypeConceptosImpl = new TypeConceptosImpl();
                            
                            foreach ($objTypeConceptosImpl->getAll() as $valor) {
                                ?>
                                <tr>
                                    ...
                                    <td id="tdAcciones">
                                        <?php
                                        echo '<a href="edit_conceptos.php?id='.$valor->getCode().'"><img src="../../res/edit-16.png"></a>';
                    ...
                    <?php echo '<p>Ultimos registros de '.$objTypeConceptosImpl->getCount().' encontrados</p>';   ?>
