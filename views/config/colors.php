        ...
        <section class="contenedor">
            ...
            <section class="contenido" id="contenidoGeneral">
                <div class="encabezadoContenido">
                    <div class="tituloContenido"><h1>Gestión Colores</h1></div><div class="agregarDato">
                        <a href="add_color.php"><input type="button" value="Agregar"></a></div><div class="buscar">
                            <input type="text" id="txbSearchColor" placeholder="Buscar...">
                        </div>                    
                </div>
                <div class="listado">
                    ...
                    <form method="post" action="">
                        <table>
                            ...
                            foreach ($objColorImpl->getAll() as $valor) {
                                ?>
                                <tr>
                                    ...
                                    <td id="tdAcciones">
                                        <?php
                                        echo '<a href="edit_color.php?id='.$valor->getCode().'"><img src="../../res/edit-16.png"></a>';
                                        echo '<a class="aDelete" href="../../controllers/ctrlDeleteColor.php?id='.$valor->getCode().'"><img src="../../res/delete-16.png"></a>';                                        
                                        ?>                                        
                                    </td>  
                                </tr>
                                <?php
                ...
                if(isset($_GET['em']))
                {
                    echo '<script>alertify.error("El color no se puede eliminar, favor revisar");</script>';          
                }
                ?>
