        ...
        <section class="contenedor">
            ...
            {?>
                <section class="contenido" id="contenidoGeneral">
                    ...
                    <form method="post" action="../../controllers/ctrlEditSystem.php">
                        <?php
                        include_once '../../models/System.php';
                        include_once '../../models/SystemImpl.php';
                        $objSystemImpl = new SystemImpl();
                        
                        foreach ($objSystemImpl->getByCode($_GET[id]) as $valor) {   
                            ...
                            echo '<input type="text" value="'.$valor->getName().'" name="txbName" placeholder="Nombre" maxlength="60">';                            
                            echo '<input type="number" value="'.$valor->getValue().'" name="txbValue" placeholder="Valor" maxlength="3">';
                            
                            $date = date_create($valor->getStartDate());
                            $dateStart = date_format($date, 'd/m/Y');
                            
                            $date = date_create($valor->getFinishDate());
                            $dateFinish = date_format($date, 'd/m/Y');
                            
                            echo '<input type="text" value="'.$dateStart.'" name="txbStartDate" placeholder="Fecha inicial">';
                            echo '<input type="text" value="'.$dateFinish.'" name="txbFinishDate" placeholder="Fecha final">';
