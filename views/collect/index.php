        ...
        <section class="contenedor">
            ...
            <section class="contenido" id="contenidoGeneral">
                ...
                <div class="encabezadoContenido">
                    <div class="tituloContenido"><h1>Seleccionar Cliente</h1></div><div class="agregarDato">
                        </div><div class="buscar">
                            <input type="text" id="txbSearchClientCollect" placeholder="Buscar...">
                        </div>                    
                </div>
                <div class="listado">
                        ...
                        <table>
                            ...
                            foreach ($objClientImpl->getAll() as $valor) {
                                ...
                                <?php }?>
                                    ...
                                    <td id="tdAcciones">
                                        <?php
                                        echo '<a href="select_credits.php?id='.$valor->getCode().'"><img src="../../res/open-in-browser-16.png"></a>';                                                                                
                                        ?>                                        
                                    </td>  
                                </tr>                                                     
                            <?php
