...
<html>
    <head>
        ...
        <script src="../../js/prompt_devol_cr.js"></script>
        ...
        <section class="contenedor">
            ...
            <section class="contenido" id="contenidoGeneral">
                ...
                <?php   
                    ...
                    <table>
                    <?php
                    foreach ($objRemisionImpl->getByCode($_GET['idf']) as $valor) {
                ...
                <div class="listado">                                        
                    <form method="post" action="../../controllers/ctrlInsertNoteCredit.php">
                        <table>
                            ...
                            foreach ($objDetailRemisionImpl->getByCodeNoDevolucion($billNumber) as $valor) {
                                ...
                                ?>
                                        ...
                                        <td class="tdDerecha" id="td4'.$cont.'">'.($valor->getQuantity() - $valor->getDevolucion()).'</td>
                                        <td class="tdDerecha" id="td5'.$cont.'">'.number_format($valor->getValueUnit(),0).'</td>
                                        <td class="tdDerecha" id="td6'.$cont.'">'.number_format( ($valor->getQuantity() - $valor->getDevolucion()) * $valor->getValueUnit()).'</td>
                                        <td class="tdNoVisible" id="td7'.$cont.'">'.$valor->getMoveDate().'</td>
                                        <td class="tdNoVisible" id="td8'.$cont.'">'.$valor->getColor().'</td>'; ?>
                                        
                                        <?php 
                                            //echo '<td id="tdAcciones"><a href="../../controllers/ctrlInsertNoteCredit.php?idf='.$valor->getCodeRemision().'&ida='.$valor->getCodeArticle().'&cl='.$valor->getColor().'&f='.$valor->getMoveDate().'&idn='.$_GET['idn'].'"> <img id="'.$cont.'" src="../../res/undo-2-16.png"></a></td>' 
                ...
                <div class="detallesDevolucion">
                    <form id="formSubmit" method="post" action="../../controllers/ctrlInsertNoteCredit.php">                        
                        <br>
