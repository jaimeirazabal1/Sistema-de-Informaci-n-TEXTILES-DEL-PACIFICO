        ...
        <section class="contenedor">
            ...
            <section class="contenido" id="contenidoGeneral">
                ...
                <div class="encabezadoContenido">
                    <div class="tituloContenido"><h1>Seleccionar Cuenta por Pagar</h1></div><div class="agregarDato"></div><div class="buscar">
                            <input type="text" id="txbSearchCxpNotes" placeholder="Buscar...">
                    </div>                    
                </div>
                
                <div class="listadoCxpCxp">
...
<!--                                <th>SALDO</th>                                -->
                            ...
                            foreach ($objCxpImpl->getAllLimit() as $valor) {
                                /*$quantityAvailable = $objCxpImpl->getQuantityAvailable($valor->getCode());
                                $quantitySale = $objCxpImpl->getQuantitySale($valor->getCode());
                                ...
                                <?php }?>
                                    ...
                                    <?php echo '<td id="td2'.$cont.'">'.$objClientImpl->getNameClient($valor->getProveedor()); ?></td>
                                     <?php 
                                        $idTC = $objClientImpl->getTypeClient($valor->getProveedor());
                                        echo '<td class="tdNoVisible" id="td6'.$cont.'">'.$idTC; 
                                        echo '<td id="td7'.$cont.'">'.$objTypeClientImpl->getNameTypeClient($idTC); 
                                     ?></td>
                                    <?php echo '<td class="tdDerecha" id="td3'.$cont.'">'.$valor->getProveedor(); ?></td>                                
                                    <?php echo '<td id="td4'.$cont.'">'.$valor->getFechaCreacion(); ?></td>                                
                                    <?php echo '<td class="tdDerecha" id="td5'.$cont.'">'.number_format($valor->getTotalCuenta()); ?></td>                                
                                    ...
                                    <td id="tdAcciones">
                                        ...
                                        echo '<a href="../notes/add_ntdb.php?idf='.$valor->getCode().'"> <img id="'.$cont.'" src="../../res/add-list-16.png"></a>';                                                                                
                                        ?>                                        
                                    </td>                                      
                                </tr>                                                     
                            <?php
