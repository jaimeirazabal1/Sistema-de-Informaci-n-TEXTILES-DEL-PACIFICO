        ...
        <section class="contenedor">
            ...
            {?>
                <section class="contenido" id="contenidoGeneral">
                    <h1>Editar Nota</h1>
                    <form method="post" action="../../controllers/ctrlEditNote.php">
                        <?php
                        include_once '../../models/Note.php';
                        include_once '../../models/NoteImpl.php';
                        $objNoteImpl = new NoteImpl();
                        

                        foreach ($objNoteImpl->getByCode($_GET['id']) as $valor) {   
                            ...
                            echo '<textarea placeholder="Observaciones de la nota" name="txaObservation" id="txa-lg">'.$valor->getObservation().'</textarea>';
                        }
