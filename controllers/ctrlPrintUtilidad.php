...
//Cabecera de página
    function Header() {      
        ...
        //$this->Cell(110);
        $this->SetFont('Times', 'B', 12);
        $this->Cell(0, 6, 'UTILIDAD DEL EJERCICIO', 1, 0, 'C');
...
//        $this->Cell(0, 10, 'Page ' . $this->PageNo() . '/{nb}', 0, 0, 'C');
    ...
    function TablaSimple($header) {        
        ...
        $this->Cell(63, 5, 'INGRESOS', 1);
        $this->Cell(63, 5, number_format($sumTotalIngresos,0), 1, 0, 'R');
        $this->Ln();
        
        $this->Cell(63, 5, utf8_decode('Ventas Credito'), 1, 0, 'R');
        $this->Cell(63, 5, number_format($sumTotalCredito,0), 1, 0, 'R');
        $this->Ln();
        
        $this->Cell(63, 5, utf8_decode('Ventas Contado'), 1, 0, 'R');
        $this->Cell(63, 5, number_format($sumTotalContado,0), 1, 0, 'R');        
        $this->Ln();

        $this->Cell(63, 5, utf8_decode('- Costos'), 1);
        $this->Cell(63, 5, number_format($sumTotalCostos,0), 1, 0, 'R');        
        $this->Ln();
        
        $this->Cell(63, 5, utf8_decode('UTILIDAD OPERATIVA'), 1);
        $this->Cell(63, 5, number_format($sumUtilidadOperativa,0), 1, 0, 'R');        
        $this->Ln();
        ...
        $this->Cell(126, 5, '', 0, 0, 'R');        
        $this->SetFont('Times', 'B', 12);
        $this->SetTextColor(48,131,155);
        $this->Cell(-95, 5, 'UTILIDAD o PERDIDA NETA: '.number_format($sumUtilidadPerdida,0), 1, 0, 'C');    
