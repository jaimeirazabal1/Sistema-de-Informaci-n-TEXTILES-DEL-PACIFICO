...
//Cabecera de página
    function Header() {      
        ...
        $this->Cell(110, 6, 'Ventas de Rayas por Color: ', 0, 0, 'L');
        //$this->Cell(110);
        $this->SetFont('Times', 'B', 12);
        $this->Cell(0, 6, 'VENTAS DE RAYAS POR COLOR', 1, 0, 'C');
...
//            $totalCantidad = $objStockImpl->getQuantity($valorStock->getCode(), $valorStock->getQuantity());
//            $totalCantidad = $quantityAvailable - $quantitySale;

            $this->Cell(35, 5, utf8_decode($valorStock->getCode()), 0, 0, 'C');
            $this->Cell(50, 5, utf8_decode($valorStock->getName()), 0);
            $this->Cell(100, 5, utf8_decode($valorStock->getDetalle()), 0);
            $this->Cell(25, 5, utf8_decode($valorStock->getQuantity()), 0);
...
$header = array('        Codigo Color', utf8_decode('Nombre Color'), utf8_decode('Nombre Articulo'), 'Ventas - KGS');
$pdf->AliasNbPages();
