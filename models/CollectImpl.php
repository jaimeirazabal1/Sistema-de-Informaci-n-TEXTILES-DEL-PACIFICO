...
class CollectImpl
{
        ...
        public function getAll()
	{
			...
			FROM recaudo rcd ORDER BY rcd.RECAUCODIG DESC";
	...
	{
            $sql = "SELECT rcd.RECAUCODIG, rcd.RECAUCREDI, rcd.RECAUCONCE, rcd.RECAUVALOR, rcd.RECAUFECHA, rcd.RECAUOBSER, rcd.RECAUUSUAR, rcd.RECAUTIPO FROM recaudo rcd WHERE rcd.RECAUCODIG = ".$idCollect;
            $conex = Conexion::getInstancia();
            $stid = oci_parse($conex, $sql);
            oci_execute($stid);
            $foo = array();
	...
	{
            $sql = "SELECT rcd.RECAUCODIG, rcd.RECAUCREDI, rcd.RECAUCONCE, rcd.RECAUVALOR, rcd.RECAUFECHA, rcd.RECAUOBSER, rcd.RECAUUSUAR, rcd.RECAUTIPO FROM recaudo rcd WHERE rcd.RECAUCREDI = ".$idCr;
            $conex = Conexion::getInstancia();
            $stid = oci_parse($conex, $sql);
            oci_execute($stid);
            $foo = array();
	...
	{            
            $sql = "SELECT DISTINCT rcd.RECAUCODIG "
                    . "FROM recaudo rcd, credito cr, cliente clnt WHERE rcd.RECAUCREDI = cr.CREDICODIG and cr.CREDICLIEN = clnt.CLIENCODIG and clnt.CLIENCODIG = ".$idc." "
	...
	{            
            $sql = "SELECT rcd.RECAUCREDI "
                    . "FROM recaudo rcd WHERE rcd.RECAUCODIG =  ".$idcr." "
	...
	{
            $sql = "SELECT rcd.RECAUFECHA, rcd.RECAUTIPO, rcd.RECAUUSUAR, rcd.RECAUOBSER FROM recaudo rcd WHERE rcd.RECAUCODIG = ".$id." AND ROWNUM < 2";
            $conex = Conexion::getInstancia();
            $stid = oci_parse($conex, $sql);
            oci_execute($stid);
            $foo = array();
        ...
        public function update(Collect $objCollect){   
            $sql = "UPDATE recaudo rcd SET rcd.RECAUVALOR = ".$objCollect->getValue().", rcd.RECAUOBSER = '".$objCollect->getObservation()."', RECAUTIPO = '".$objCollect->getTypePay()."' WHERE rcd.RECAUCODIG = ".$objCollect->getCode();
            $conex = Conexion::getInstancia();
            $stid = oci_parse($conex, $sql);
            oci_execute($stid);            
        }
...
//        } 
        ...
        public function getCountCollectBetweenDate($dateA, $dateB, $client, $credit, $bill)
	{
            if(strcmp($client, "") != 0 && strcmp($credit, "") == 0 && strcmp($bill, "") == 0 ) 
            {
                ...
                . "WHERE rcd.RECAUCREDI = cr.CREDICODIG AND cr.CREDICLIEN = ".$client." AND rcd.RECAUFECHA BETWEEN TO_DATE('".$dateA." 00:00:00', 'yyyy/mm/dd hh24:mi:ss') AND TO_DATE('".$dateB." 23:59:59', 'yyyy/mm/dd hh24:mi:ss') ";
            }
            else if(strcmp($client, "") == 0 && strcmp($credit, "") != 0 && strcmp($bill, "") == 0 ) 
            {
                $sql = "SELECT COUNT(*) FROM recaudo rcd "
                . "WHERE rcd.RECAUCREDI = ".$credit." AND rcd.RECAUFECHA BETWEEN TO_DATE('".$dateA." 00:00:00', 'yyyy/mm/dd hh24:mi:ss') AND TO_DATE('".$dateB." 23:59:59', 'yyyy/mm/dd hh24:mi:ss') ";
            }
            else if(strcmp($client, "") == 0 && strcmp($credit, "") == 0 && strcmp($bill, "") != 0 ) 
            {
                $sql = "SELECT COUNT(*) FROM recaudo rcd, credito cr "
                . "WHERE rcd.RECAUCREDI = cr.CREDICODIG AND cr.CREDIFACTU = ".$bill." AND rcd.RECAUFECHA BETWEEN TO_DATE('".$dateA." 00:00:00', 'yyyy/mm/dd hh24:mi:ss') AND TO_DATE('".$dateB." 23:59:59', 'yyyy/mm/dd hh24:mi:ss') ";
            }            
...
//                . "ORDER BY cr.CREDICODIG";
            ...
            else if(strcmp($client, "") == 0 && strcmp($credit, "") != 0 && strcmp($bill, "") == 0 ) 
            {
                ...
                . "WHERE rcd.RECAUCREDI = ".$credit." AND rcd.RECAUFECHA BETWEEN TO_DATE('".$dateA." 00:00:00', 'yyyy/mm/dd hh24:mi:ss') AND TO_DATE('".$dateB." 23:59:59', 'yyyy/mm/dd hh24:mi:ss') ORDER BY rcd.RECAUFECHA";
            ...
            {
                $sql = "SELECT * FROM recaudo rcd, credito cr "
                . "WHERE rcd.RECAUCREDI = cr.CREDICODIG AND cr.CREDIFACTU = ".$bill." AND rcd.RECAUFECHA BETWEEN TO_DATE('".$dateA." 00:00:00', 'yyyy/mm/dd hh24:mi:ss') AND TO_DATE('".$dateB." 23:59:59', 'yyyy/mm/dd hh24:mi:ss') ORDER BY rcd.RECAUFECHA";
