<?php
    ...
    if (!empty($buscar)) {
        ...
        {
            $sql = "SELECT * FROM inventario invtr WHERE UPPER(invtr.INVENCODIG) LIKE UPPER ('%" . $buscar . "%') 
                ...
                <?php }?>
                    ...
                    <?php
                        if(strcmp ($row[2], 'E') == 0 || strcmp ($row[2], 'e') == 0)
                            ...
                            echo '<td></td>';
                        ?>                                
                    <td class="tdDerecha"><?php echo $row[3]; ?></td>                                
                    ...
                    <td id="tdAcciones">
                        <?php
                        echo '<a href="edit_stock.php?id='.$row[0].'&n='.$row[1].'&c='.$row[6].'"><img src="../../res/edit-16.png"></a>';                                                                                
                        echo '<a href="edit_prices.php?id='.$row[0].'&n='.$row[1].'&c='.$row[6].'"><img src="../../res/edit-property-16.png"></a>';                                                                                
                        ?>                                        
                    </td> 
